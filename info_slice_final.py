...
if df_forecast is not None:
    ...
    # Certifique-se de que vdu_details_df esteja definido anteriormente no seu código
    # print(vdu_details_df)  # Descomente esta linha se vdu_details_df estiver definido
